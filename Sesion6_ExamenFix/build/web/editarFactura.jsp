    ...
    <table border=1 width="70%">
      ...
      for (int i=0;i<listadoArticulosComprados.size();i++) {
        ...
        <tr>
          ...
          <td>
            <a href="Controller?opID=delFactura&&idFactura=<jsp:getProperty name="FacturaCliente" property="id"/>&&borraArticulo=<%=_articulo.getId()%>&&cantidadArticulo=<%=_articulo.getCantidadComprada()%>">
              Borrar
            </a>
          </td>
        </tr>
