...
public class FacturaBLL {
    ...
    public void delArticulo(Cliente cliente,Factura factura,Articulo articulo,int numero) throws Exception
    {
        Connection _con=null;
        try {            
            Conexion_DB _conexion_DB = new Conexion_DB();
            ...
            FacturaDAO facturaDAO=new FacturaDAO();
            facturaDAO.borrarArt(_con, factura.getId(), articulo.getId());//Inserta la linea de factura
    ...
    public void borrarFactura(Factura factura) throws Exception{
            ...
            _con = _conexion_DB.AbrirConexion();
            FacturaDAO factura_DAO = new FacturaDAO();
            factura_DAO.borrarFactura(_con, factura);
            _conexion_DB.CerrarConexion(_con);
